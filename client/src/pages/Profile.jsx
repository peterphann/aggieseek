      ...
      <div>
        <div
          ...
          <div className="flex items-center justify-center w-full max-w-4xl px-4 my-4 "> {/* Content container */}
            <h2 className="text-3xl font-bold absolute w-full text-center pointer-events-none">Profile</h2> {/* Absolutely positioned to center */}
              ...
              <div className="">
                ...
                <div>
                  <Menu>
                    ...
                    <Menu.Items
                        className="w-[20%] absolute mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
                          ...
                          {({active}) => (
                              ...
                              >
                                <Input type="file" onClick={(e) => e.stopPropagation()}
                                       className="h-10 shadow-none px-1"/>
                                <button
